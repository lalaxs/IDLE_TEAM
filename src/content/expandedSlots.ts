...
const CH3: ExpandedItem[] = [
  ...
  { id: "ring_caravan_bell", name: "驼队印戒", slot: "ring", chapter: 3, iconDonor: "accessory_caravan_bell" },
...
export const EXPANDED_TRAIT_DEFINITIONS = [
  ...
  { id: "deflect", name: "偏斜", slot: "off_hand" as const, description: "格挡率提高" },
  { id: "reprisal", name: "回敬", slot: "off_hand" as const, description: "反弹受到的近战伤害" },
  { id: "keen", name: "锐目", slot: "helmet" as const, description: "暴击率提高" },
  { id: "foresight", name: "先见", slot: "helmet" as const, description: "每波开始时获得怒气" },
  { id: "resolve", name: "定志", slot: "helmet" as const, description: "最大生命提高" },
  { id: "fleet", name: "疾手", slot: "gloves" as const, description: "普攻速度提高" },
  { id: "combo", name: "连势", slot: "gloves" as const, description: "普攻伤害提高" },
  { id: "leeching", name: "汲取", slot: "gloves" as const, description: "造成伤害时获得生命偷取" },
  { id: "sturdy", name: "稳行", slot: "boots" as const, description: "最大生命提高" },
  { id: "windstep", name: "风行", slot: "boots" as const, description: "移动速度提高" },
  { id: "elusive", name: "无踪", slot: "boots" as const, description: "闪避率提高" },
  { id: "sanguine", name: "饮血", slot: "ring" as const, description: "技能伤害提高" },
  { id: "cruelty", name: "酷烈", slot: "ring" as const, description: "暴击伤害提高" },
  { id: "surge", name: "涌势", slot: "ring" as const, description: "全伤害提高" },
  { id: "warding", name: "护脉", slot: "bracer" as const, description: "受到伤害降低" },
  { id: "parry", name: "招架", slot: "bracer" as const, description: "格挡率提高" },
  { id: "barbed", name: "倒刺", slot: "bracer" as const, description: "反弹受到的近战伤害" },
  { id: "insight", name: "灵息", slot: "earring" as const, description: "怒气获取提高" },
  { id: "echoing", name: "回响", slot: "earring" as const, description: "技能伤害提高" },
  { id: "vitality", name: "生息", slot: "earring" as const, description: "最大生命提高" },
] as const;
